...
public class GEOSoftNames
{
  ...
  public final static String PLATFORM_GPL_FIELD_NAME = "gpl";
  ...
  public final static String[] PLATFORM_FIELD_NAMES = { PLATFORM_GPL_FIELD_NAME, PLATFORM_TITLE_FIELD_NAME, PLATFORM_DISTRIBUTION_FIELD_NAME,
